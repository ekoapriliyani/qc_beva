...
<head>
    <meta charset="UTF-8">
    <title>Login - QC Coating</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        body { background: #f8f9fc; height: 100vh; display: flex; align-items: center; }
    ...
    <div class="card card-login shadow mx-auto">
        <div class="card-body p-5">
            <div class="text-center mb-4">
                ...
                <h4 class="mt-3 fw-bold">QC Coating System</h4>
            ...
            <form action="" method="POST">
                ...
                <button type="submit" name="login" class="btn btn-primary w-100 py-2 fw-bold">Login Now</button>
            </form>
        </div>
    </div>
</div>
