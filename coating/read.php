...
$query_hitung = "SELECT COUNT(DISTINCT h.id) AS total FROM t_coating_header h 
...
$sql = "SELECT 
            h.id AS header_id, h.tgl, h.report_no, h.drawing_no,
            p.name AS nama_proyek, s.nama AS nama_subkon, p.no_pro AS no_pro, p.qty AS qty,
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="tambah_detail.php?id_coating=<?= $row['header_id']; ?>" class="btn btn-sm btn-outline-primary" title="Edit/Tambah Detail">
