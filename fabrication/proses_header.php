...
$query = "INSERT INTO t_fabrication_header (pro_number, qty, id_project, id_subkon, tgl, report_no, drawing_no) 
...
if (mysqli_query($conn, $query)) {
    ...
    header("Location: tambah_detail.php?id_fabrication=$last_id");
} else {
